  ...
  displayMaker = (map) => {
    ...
    AnimalPharmacyData.forEach((element) => {
     ...
     var pharmacy_wrap = document.createElement('div');
      ...
      modal_addr1.innerHTML = `${element.roadAdress ? element.roadAdress : "도로명 주소 정보가 없습니다"}`;
      ...
      modal_addr2.innerHTML = `${element.adress ? element.adress : "주소 정보가 없습니다"}`;
      ...
      num1.innerHTML = `${element.tel ? element.tel : "연락처 정보가 없습니다"}`;
